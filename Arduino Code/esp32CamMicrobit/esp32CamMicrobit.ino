/** ESP32-Cam Web Robot Project
  ...
  * This project creates an HTTP server to stream video, receive
...
Ticker ticker;
  ...
  #define ESP_LED 4
  //#define ESP_POWER 2 // RANDI if you want to use a pin to turn on/off the camera
#endif
...
void setup() {
  ...
  Serial.begin(115200);
  bool debug = false;  // RANDI make true while testing
